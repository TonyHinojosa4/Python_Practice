...
def available_on_night(gamers_list, day):
    players_available_thursday = []
    for gamer in gamers_list:
        if day in gamer['availability']:
            players_available_thursday.append(gamer)
    return players_available_thursday
...
form_email = "It is here! {name} You are invited on {day_of_week} to play your favorite game, {game}"
...
def not_available_thursday(gamers_list, day):
    players_not_available = []
    for gamer in gamers_list:
        if day not in gamer['availability']:
            players_not_available.append(gamer)
    return players_not_available

unable_to_attend_best_night = not_available_thursday(gamers, game_night)
